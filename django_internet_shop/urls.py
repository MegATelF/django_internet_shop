...
urlpatterns = [
    ...
    path("product_list/<int:item_id>", views.product_list, name="product_list"),
    path("items/", views.items, name="items"),
    path("items-card/", views.items_card, name="items-card"),
    path("items-cart/", views.items_cart, name="items-cart"),
